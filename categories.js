export const CATEGORIES = [
  { cat: "Pendapatan", keys: ["gaji", "gajji", "bonus", "bns", "cashback", "refund", "affiliate", "thr", "komisi", "dividen", "bunga", "hibah", "transfer", "titip", "jual", "cair", "masuk", "cuan", "profit", "hadiah", "claim", "reimburse", "kembalian", "topup"] },
  ...
  { cat: "Hiburan", keys: ["bioskop", "nonton", "cinema", "xxi", "wisata", "liburan", "hotel", "staycation", "villa", "pantai", "game", "topup game", "hobi", "konser", "nongkrong", "cafe"] },
  { cat: "Investasi", keys: ["bibit", "ajaib", "bareksa", "saham", "reksadana", "obligasi", "sbn", "emas", "antam", "uob", "crypto", "bitcoin", "deposito", "tabungan", "aset"] }
];
